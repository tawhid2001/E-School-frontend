const courseDetailinfo = (courseId) => {
  return fetch(`https://e-school-backend.onrender.com/course/${courseId}`)
    .then((res) => {
      if (!res.ok) {
...
const enrolledCourses = async () => {
  try {
    ...
    const response = await fetch("https://e-school-backend.onrender.com/enroll/my-enrollments/", {
      method: "GET",
      headers: {
            ...
            <div class="card">
              ...
              <div id="course-progress"></div>
                ...
                <div class="d-flex justify-content-evenly">
                  <p class="btn btn-primary detail-btn"><a href="./course_detail.html?id=${enrolled.course}">Details</a></p>
  ...
  const fetchEnrollments = () => {
    ...
    fetch('https://e-school-backend.onrender.com/enroll/my-enrollments/', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Token ${token}`,
  ...
  const disenroll = (enrollmentId, courseId) => {
    ...
    fetch(`https://e-school-backend.onrender.com/enroll/enrollments/${enrollmentId}/`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Token ${token}`,
